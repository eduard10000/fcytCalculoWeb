...
"dd/mm/yyyy" "(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d" -->
    <div class="registro">
        <div class="formularioRegistro">
            <form id="formularioRegistro" method="post" action="registrarse"  enctype="multipart/form-data" accept-charset="utf-8">
                <div>Dni</div>
                <input id="dni" value="" name="dni" title="Ingrese su DNI" type="number" required><br/>
                <div>Contraseña</div>
                <input id="contrasenia" value="" type="password"  name="contrasenia" title="La contraseña debe tener al menos 6 caracteres y puede contener letras, números, '_','-', o '.' " required pattern="[1-9A-Za-z\x2d\x2e\x5f]{6,}" onKeyup="samePass();" onChange="samePass();"><br/>
                <div>Repetir Contraseña</div>
                <input id="repetir" type="password"  value=""  name="repetir" title="Repita la contraseña ingreses previamente" required pattern="[1-9A-Za-z\x2d\x2e\x5f]{6,}" onChange="samePass();" onKeyup="samePass();"><br/>
